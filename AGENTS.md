...
IMPORTANT: After changing commands, flags, or CLI behavior, always update README.md and AGENTS.md. This is not optional. README.md is the public-facing documentation and must reflect the current CLI surface.
